...
If getting issue with Content Sync module or because of any other module, these patches can help for Content Sync module :
...

    {
      "patches": {
        "drupal/classy_paragraphs": {    
           "classy_paragraphs routing issue fixed": "https://www.drupal.org/files/issues/2020-06-10/reroll-4-refactor_classy-2900726-9.patch"
        }
      }
    }
...
Issues :
...

    {
      "patches": {
        "drupal/content_sync": {    
           "Import doesn't work; looking for entityManager on ContentEntityNormalizer": "https://www.drupal.org/files/issues/2019-05-06/content_sync-entity_manager_refs.patch",
           "The specified translation (und) cannot be removed": "https://www.drupal.org/files/issues/2018-05-18/2973854-1.patch"
        }
      }
    }
